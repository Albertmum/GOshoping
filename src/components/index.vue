<template>
    <div>
                            ...
                            <ul>
                                <li v-for="(item) in catelist" :key='item.id'>
                                    <h3>
                                        ...
                                        <p>
                                            <span v-for="(item2) in item.subcates" :key='item2.id'>
                                                {{item2.title}}&nbsp;
                                            </span>
        ...
        <div v-for="(item) in goodList" :key='item.id' class="section">
            <div class="main-tit">
                <h2>{{item.catetitle}}</h2>
                <p>
                    <a v-for="(item2) in item.level2catelist" :key='item2.subcateid' href="/goods/43.html">{{item2.subcatetitle}}</a>
                ...
                <div class="wrap-box">
                    <ul class="img-list">
                        <li v-for="(item3) in item.datas" :key="item3.artID">
                            <router-link :to="'/goodsinfo/'+item3.artID">
                           
                            <!-- <a href="#/site/goodsinfo/87" class=""> -->
                                <div class="img-box">
                                    <img v-lazy="item3.img_url">
                                </div>
                                <div class="info">
